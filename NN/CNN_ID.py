...
num_filt_2 = 5     #Number of filters in second conv layer
num_filt_3 = 5     #Number of filters in thirs conv layer
num_fc_1 = 6       #Number of neurons in hully connected layer
...
if KDD:
  ...
  data_train = np.loadtxt(datadir+'Train+.txt',delimiter=',')
  data_test_val = np.loadtxt(datadir+'Test+.txt',delimiter=',')
else:
...
with tf.name_scope("Conv1") as scope:
  W_conv1 = tf.get_variable("Conv_Layer_1", shape=[1, 1, 1, num_filt_1],initializer=initializer)
...
with tf.name_scope("Conv2") as scope:
  W_conv2 = tf.get_variable("Conv_Layer_2", shape=[1, 1, num_filt_1, num_filt_2],initializer=initializer)
